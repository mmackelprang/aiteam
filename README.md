...
- 📋 **[`docs/implementation-plan.md`](docs/implementation-plan.md)** — the working plan: component placement across dev computer / NAS / appserver (grounded in the `mmackelprang/homelab` repo's conventions, §1.0), review findings F1–F18 (Google Chat per-agent identities, project-onboarding-as-configuration, the Beads + claude-mem memory-layer watch-list, and more), the staged plan for both systems, and the decision list D1–D9 — **all resolved 2026-07-23**: pilot repos RTest / homelab / FamilyWorkspace, harness pilot FamilyWorkspace, git-as-transport, Tier-0 allowlists, subscription-auth first.
