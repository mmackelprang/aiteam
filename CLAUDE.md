...
- `docs/implementation-plan.md` is the working plan: host topology (dev computer / NAS / appserver), review findings F1–F21 (F17/F18/F21-L3 = the memory/re-context watch-list — Beads, claude-mem, persistent sessions + cross-session messaging; **one** H-Task 9 bake-off decision, adopt only on pilot evidence + user sign-off; F20 = dashboard-gallery patterns, `portfolio/docs/research-obsidian-dashboard-gallery.md`; F21 = cross-session messaging, `harness/docs/research-cross-session-messaging.md`), staged sequencing for both systems, decisions D1–D10 resolved, **D11–D12 open** (F20 dashboard patterns; F21 messaging scope — see plan §5). Read it before starting any stage; keep its stage checklist current as work lands.
