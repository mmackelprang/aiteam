...
- `docs/implementation-plan.md` is the working plan: host topology (dev computer / NAS / appserver), review findings F1–F15, staged sequencing for both systems, open decisions D1–D8. Read it before starting any stage; keep its stage checklist current as work lands.
